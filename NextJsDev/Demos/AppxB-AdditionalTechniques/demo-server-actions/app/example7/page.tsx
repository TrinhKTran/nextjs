...
export function SubmitButton({label} : {label: string}) {
  ...
  // The useFormStatus() hook enables you to specify an "pending" UI while the form is being submitted.
  ...
  return (
    <>
      ...
      >
        ...
        <SubmitButton label='Submit' />  { /* This is our custom component, see above */ }
