...
export default function Example8() {
  ...
  // Use the useActionState() hook to hold component state at the server, rather than in the component itself.
    ...
    <>
      ...
      <form
        ...
        action={async (formData) => {
          ...
          // Note: "formAction" is our handle to the stateful server action (see the useActionState() call at top of function).
